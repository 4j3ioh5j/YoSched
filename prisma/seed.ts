...
async function main() {
  ...
  const shiftTypes = [
    ...
    { code: "ORC",    name: "OR Call",               defaultHours: 16, countsTowardFte: true,  isLeave: false, isPaid: true,  category: "work",  color: "#8b5cf6", sortOrder: 2, schedulePriority: 20, noConsecutiveGroup: "call-late", maxPerDay: 1, boldOnSchedule: true },
    { code: "ORL",    name: "OR Late",               defaultHours: 12, countsTowardFte: true,  isLeave: false, isPaid: true,  category: "work",  color: "#6366f1", sortOrder: 3, schedulePriority: 30, noConsecutiveGroup: "call-late", maxPerDay: 1, boldOnSchedule: true },
    ...
    { code: "CALL",   name: "Weekend Call",            defaultHours: 0,  countsTowardFte: false, isLeave: false, isPaid: false, category: "work",  color: "#14b8a6", sortOrder: 10, schedulePriority: 10, weekendPaired: true, ignoresWorkingDays: true, noConsecutiveGroup: "call-late", maxPerDay: 1, boldOnSchedule: true },
